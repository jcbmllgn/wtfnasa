...
class FactsControllerTest < ActionController::TestCase
  ...
  test "should create fact" do
    assert_difference('Fact.count') do
      post :create, fact: { description: @fact.description, downvote: @fact.downvote, title: @fact.title, upvote: @fact.upvote, url: @fact.url }
    end
  ...
  test "should update fact" do
    patch :update, id: @fact, fact: { description: @fact.description, downvote: @fact.downvote, title: @fact.title, upvote: @fact.upvote, url: @fact.url }
    assert_redirected_to fact_path(assigns(:fact))
  end
